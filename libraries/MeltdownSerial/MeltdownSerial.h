...
#pragma region COMMANDS
			...
			const String ENABLE_FULL_PURPLE = "EPRP";
			const String DISABLE_FULL_PURPLE = "DPRP";
			const String ENABLE_FULL_YELLOW = "EYLW";
			const String DISABLE_FULL_YELLOW = "DYLW";
			const String ENABLE_FULL_RAINBOW = "ERNB";
			const String DISABLE_FULL_RAINBOW = "DRNB";
			const String ENABLE_FULL_GREEN = "EGRN";
			const String DISABLE_FULL_GREEN = "DGRN";
