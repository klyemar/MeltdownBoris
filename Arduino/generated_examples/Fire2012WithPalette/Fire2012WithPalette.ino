...
void SetBrightness()
{
    gBrightness = MeltdownLED.GetAnalogValue(BRIGHTNESS_PIN, gBrightness, MIN_BRIGHTNESS, MAX_BRIGHTNESS);
...
void SetHue()
{
    gHue = MeltdownLED.GetAnalogValue(HUE_PIN, gHue, MIN_HUE, MAX_HUE);
}
